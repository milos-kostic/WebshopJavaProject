...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/front/favicon.ico" type="image/x-icon" />
    ...
    <section class="homepage-main-slider-index">
        ...
        <ul class="lead-slider-1 list-unstyled owl-carousel owl-loaded owl-drag">
           			...
           			<c:forEach var="slider" items="${sliders}">
            			<li 
            				class="d-flex" 
            				style="background-image: linear-gradient(180deg, rgba(0,0,0,0) 0%, #000000 100%), url('${slider.image}')">
		                    <div class="container align-self-end">
		                        <div class="lead-slider-details">
		                            ...
		                            <a href="${slider.url}" class="d-inline-block btn btn-warning text-uppercase">${slider.buttonTitle}</a>
		                        </div>
                    		</div>
                		</li>
               		</c:forEach>
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-2 mb-lg-0">
                    <div class="bg-secondary b-radius">
                        <a href="#" class="d-flex justify-content-center align-items-center py-3 py-lg-4">
                            <figure class="mb-0"><img class="d-inline-block" 
                            src="${pageContext.request.contextPath}/front/img/index/key.png" alt="" /></figure>
                ...
                <div class="col-12 col-md-6 mb-2 mb-lg-0">
                    <div class="bg-secondary b-radius">
                        <a href="#" class="d-flex justify-content-center align-items-center py-3 py-lg-4">
                            <figure class="mb-0"><img class="d-inline-block" 
                            src="${pageContext.request.contextPath}/front/img/index/shopping-cart.png" alt="" />
                            </figure>
                ...
                <li>
                    <article class="popular-products-item mb-2 mb-lg-0">
                        <figure class="mb-3 d-flex justify-content-center align-items-center">
                            <a href="shop-detail/${product.seoTitle}/${product.id}" class="d-block">
                            <img src="${product.image}" alt="" /></a>
                            
                            <!-- 
                            <c:forEach var="sticker" items="${product.stickers}">
                               <p style="background-color: ${sticker.color};" class="discount">  
                                 ${sticker.title}                
                               </p>  
   							</c:forEach>
   							 -->
   							 
   							 <c:set var="randomSticker" value="${product.randomSticker}" />
   							 	<!-- samo jednom pozovi randomSticker i upisi rezultat u prom randomSticker 
   							 		jer je bio problem sa bojom kad je pozivao ponovo metodu za boju. -->
   							 <c:if test="${randomSticker!=null}">
   							 	<p style="background-color: ${randomSticker.color};" class="discount">
   							 		${randomSticker.title}
   							 	</p>
   							 </c:if>
   							 
   							<!-- // ovde je bio problem za boju, pozivao je metodu ponovo pa je bila po0gresna boja
   							 <c:if test="${product.randomSticker != null}">
   							  <p style="background-color: ${product.randomSticker.color};" class="discount">  
                                 ${product.randomSticker.title}           
                                // u pozadini poziva getRandomSticker()      
                              </p>  
                              </c:if>
                       		 --> 	   
