...
<body>
    ...
    <main>
        ...
        <section class="shop-1 popular-products mb-2 mb-lg-4" style="background-color: #fff;">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <c:forEach var="category" items="${categories}">
                                     ...
                                     <!--  moze ovako:
                                    	<c:choose> 
                                    		<c:when test="${category.id==categorySelected}">
            ...
            <option value="${category.id}" <c:if test="${category.id==categorySelected}">selected="selected"</c:if> >${category.name}</option>
                            ...
                            <div class="form-group mb-5">
                                <h5 class="text-uppercase mb-2">Sticker</h5>
                                ...
                                <c:forEach var="sticker" items="${stickers}">
                                    ...
                                    <input type="checkbox" 
                                    		name="sticker" 
                                    		value="${sticker.id}" <c:if test="${stickersSelected.contains(sticker.id)}">checked</c:if>>
                                    		<!-- 
                                    			metoda .contains radi sa Listama pa se u kontroleru promeni: 
                                    			Arrays.asList(stickersArray)  
                                    		-->
                                    	${sticker.title}
                            ...
                            <div class="form-group mb-5">
                                <h5 class="text-uppercase mb-2">Price</h5>
                                <label class="d-flex">
                                    <input type="radio" name="price" value="1" <c:if test="${priceSelected==1}">checked</c:if> >
                                    &lt; 5000
                                    <!--
                                              Use &lt; for lower than  or &gt;  for greater than 
                                                Do not use < or >. That may couse an error, becouse indicates open or close tag
                                        -->
                                    <span class="fake-element"></span>
                                </label>
                                <label class="d-flex">
                                    <input type="radio" name="price" value="2"  <c:if test="${priceSelected==2}">checked</c:if> >
                                    &lt; 10000
                                    <span class="fake-element"></span>
                                </label>
                                <label class="d-flex">
                                    <input type="radio" name="price" value="3"  <c:if test="${priceSelected==3}">checked</c:if> >
                                    &lt; 15000
                                    <span class="fake-element"></span>
                                </label>
                            </div>
                            ...
                            <div class="col-xxm-6 col-md-4">
                                <article class="popular-products-item mb-2
                                    ...
                                    <figure class="mb-3 d-flex
                                        ...
                                        align-items-center">
                                        <a href="shop-detail?id=${product.id}" class="d-block">
                                    ...
                                    <div class="popular-products-details
                                        ...
                                        <h5 class="mb-1"><a href="shop-detail?id=${product.id}" class="text-uppercase">
                                       			${product.title}</a></h5>
