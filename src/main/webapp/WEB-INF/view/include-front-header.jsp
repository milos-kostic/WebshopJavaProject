    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-12 col-lg-6 header-details text-center
             text-lg-left">
                <div>
                    <a class="d-inline-block mr-lg-4" href="#">
                    <img class="mobile" 
                    src="${pageContext.request.contextPath}/front/img/icons/mobile.png"
            ...
            <div class="col-12 col-lg-3 d-lg-flex justify-content-end">
                ...
                <!-- product smo stavili za admin a shop za front deo proizvoljno -->
