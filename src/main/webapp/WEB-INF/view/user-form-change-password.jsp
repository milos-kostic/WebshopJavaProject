                  ...
                  <div class="row">
                    <div class="col-md-6">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <form:input type="password" class="form-control" placeholder="Enter old password"
	                        		path="oldPassword" />
	                        		<!--  path je naziv polja u toj klasi -->
	                      </div>
	                       
	                      <div class="form-group">
	                        <label>New password</label>
	                        <form:input type="password" class="form-control" placeholder="Enter new password"
	                        		path="newPassword" />
	                        		<!--  path je naziv polja u toj klasi -->
	                      </div> 
