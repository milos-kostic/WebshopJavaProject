        ...
        <section class="product-breadcrumb d-none d-lg-block" style="background: #fff;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <!-- <li class="breadcrumb-item active">Stiga bacači snega</li>  ovo ne treba bila je potkategorija -->
                </ol>
            </nav>
        </section>
    </div>
                    ...
                    <div class="single-product-details">
                        ...
                        <div class="sticker-wrapper">
                        	...
                        	<c:forEach var="sticker" items="${product.stickers}">
                            	<!-- <span class="sticker" style="background-color: #ff0000;">10%</span>  -->
                            	<span class="sticker" style="background-color: ${sticker.color};">${sticker.title}</span>
                            </c:forEach>
                            
                        </div>
                        <!-- <h6 class="text-uppercase">STIGA 18-2802-31</h6> Sifra proizvoda. 
                        	Sifru odredjuje prodavac. Treba da postoji kolona u tabeli products. Unique. 
                        treba nova kolona u tabeli: sifra_proizvoda, pa u entitetu novo polje, geteri i seteri, i u formi za unos.
                        samostalno. Privremeno: 
                        	 -->
                        <h6 class="text-uppercase">${product.category.name} - ${product.id}</h6>
                        <!--  za fejs link isto treba kolona u tabeli products, moze i za instagram i sl.
                        	link_do_fb, link_do_insta, link_do_yt,
                        	novo polje u entitet klasi, geteri i seteri.
                        	ostavljamo ovako.
                         --> 
                        <iframe
                        ...
                        <h5 class="text-uppercase">${product.price} din</h5><!-- za formatiranje cene moze get metoda 
                        pa je pozivamo ovde. -->
                    </div>
                </div>
            </div>
                ...
                <li>
                    <article class="popular-products-item mb-2 mb-lg-0">
                        ...
                        <div class="popular-products-details text-center text-lg-left">
                            ...
                            <p class="text-uppercase mb-2">${product.category}</p>
                            <p class="text-uppercase">${product.price} din</p>
                            <!-- formatiranje cene napravi get metodu pa ovde pozovi -->
                        </div>
                    </article>
                </li>
                </c:forEach>
